...
const SendMessageModal = ({ newMessage, handleMessageInputChange, volunteers, attendees, events, onClose, onSend }) => {
  return (
    <div
      role="dialog"
      aria-modal="true"
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '16px', marginBottom: '20px' }}>
          <div style={{ flex: 1 }}>
            ...
            <select
              ...
              onChange={(e) => handleMessageInputChange('type', e.target.value)}
              style={{
                width: '100%',
                padding: '8px',
          ...
          <div style={{ flex: 1 }}>
            ...
            <select
              value={newMessage.sendVia}
              onChange={(e) => handleMessageInputChange('sendVia', e.target.value)}
              style={{
                width: '100%',
                padding: '8px',
                border: '1px solid #d1d5db',
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <select
            ...
            onChange={(e) => handleMessageInputChange('recipients', e.target.value)}
            style={{
              width: '100%',
              padding: '8px',
              border: '1px solid #d1d5db',
        ...
        {(newMessage.recipients === 'event-volunteers' || newMessage.recipients === 'event-attendees') && (
          <div style={{ marginBottom: '16px' }}>
            ...
            <select
              value={newMessage.eventId}
              onChange={(e) => handleMessageInputChange('eventId', e.target.value)}
              style={{
                width: '100%',
                padding: '8px',
                border: '1px solid #d1d5db',
